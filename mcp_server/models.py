...
class AddDnsRecordSetMetadata(BaseModel):
    pass


class AddDnsZoneMetadata(BaseModel):
    pass


class AddRolesMetadata(BaseModel):
    pass
...
class AddSubnetworkRequest(BaseModel):
    ...
    consumerNetwork: Optional[str] = Field(
        None,
    ...
    description: Optional[str] = Field(
        None, description='An optional description of the subnet.'
    )
    ipPrefixLength: Optional[int] = Field(
        None,
    ...
    requestedAddress: Optional[str] = Field(
        None,
    ...
    subnetworkUsers: Optional[List[str]] = Field(
        None,
...
class CloudSQLConfig(BaseModel):
    service: Optional[str] = Field(
        None, description='Peering service used for peering with the Cloud SQL project.'
    )
    umbrellaNetwork: Optional[str] = Field(
        None,
        description='The name of the umbrella network in the Cloud SQL umbrella project.',
    )
    umbrellaProject: Optional[str] = Field(
        None, description='The project number of the Cloud SQL umbrella project.'
    )
...
class ConsumerConfigMetadata(BaseModel):
    pass
...
class DeleteConnectionMetadata(BaseModel):
    pass


class DeletePeeredDnsDomainMetadata(BaseModel):
    pass
...
class DnsRecordSet(BaseModel):
    ...
    type: Optional[str] = Field(
        None, description='Required. The identifier of a supported record type.'
    )


class DnsZone(BaseModel):
    dnsSuffix: Optional[str] = Field(
        None,
...
class GoogleCloudServicenetworkingV1ConsumerConfigReservedRange(BaseModel):
    ...
    ipPrefixLength: Optional[int] = Field(
        None, description='The prefix length of the reserved range.'
    )
    name: Optional[str] = Field(None, description='The name of the reserved range.')


class GoogleCloudServicenetworkingV1betaConnection(BaseModel):
    network: Optional[str] = Field(
        None,
        description="The name of service consumer's VPC network that's connected with service producer network, in the following format: `projects/{project}/global/networks/{network}`. `{project}` is a project number, such as in `12345` that includes the VPC service consumer's VPC network. `{network}` is the name of the service consumer's VPC network.",
    )
...
class GoogleCloudServicenetworkingV1betaSubnetwork(BaseModel):
    ipCidrRange: Optional[str] = Field(
        None, description='Subnetwork CIDR range in `10.x.x.x/y` format.'
    )
    name: Optional[str] = Field(
        None,
    ...
    outsideAllocation: Optional[bool] = Field(
        None,
...
class ListConnectionsResponse(BaseModel):
    connections: Optional[List[GoogleCloudServicenetworkingV1betaConnection]] = Field(
        None, description='The list of Connections.'
    )
...
class PartialDeleteConnectionMetadata(BaseModel):
    pass


class PeeredDnsDomain(BaseModel):
    dnsSuffix: Optional[str] = Field(
        None,
...
class PeeredDnsDomainMetadata(BaseModel):
    pass
...
class RemoveDnsRecordSetMetadata(BaseModel):
    pass


class RemoveDnsRecordSetResponse(BaseModel):
    pass


class RemoveDnsZoneMetadata(BaseModel):
    pass


class RemoveDnsZoneResponse(BaseModel):
    pass


class Route(BaseModel):
    destRange: Optional[str] = Field(
        None, description='Destination CIDR range that this route applies to.'
    )
    name: Optional[str] = Field(
        None, description='Route name. See https://cloud.google.com/vpc/docs/routes'
    )
    network: Optional[str] = Field(
        None,
...
class SecondaryIpRange(BaseModel):
    ipCidrRange: Optional[str] = Field(
        None, description='Secondary IP CIDR range in `x.x.x.x/y` format.'
    )
    rangeName: Optional[str] = Field(
        None, description='Name of the secondary IP range.'
    )
...
class Subnetwork(BaseModel):
    ...
    region: Optional[str] = Field(
        None, description='GCP region where the subnetwork is located.'
    )
    secondaryIpRanges: Optional[List[SecondaryIpRange]] = Field(
        None, description='List of secondary IP ranges in this subnetwork.'
    )
...
class UpdateDnsRecordSetMetadata(BaseModel):
    pass
...
class AddDnsZoneResponse(BaseModel):
    consumerPeeringZone: Optional[DnsZone] = Field(
        None, description='The DNS peering zone created in the consumer project.'
    )
    producerPrivateZone: Optional[DnsZone] = Field(
        None,
...
class AddRolesResponse(BaseModel):
    policyBinding: Optional[List[PolicyBinding]] = Field(
        None,
...
class ConsumerConfig(BaseModel):
    ...
    usedIpRanges: Optional[List[str]] = Field(
        None,
        description='Output only. The IP ranges already in use by consumer or producer',
    )
    vpcScReferenceArchitectureEnabled: Optional[bool] = Field(
        None,
